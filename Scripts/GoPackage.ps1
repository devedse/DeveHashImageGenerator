...
$7zFilePath = Join-Path $outputDir "DeveHashImageGenerator.7z"
$zipFilePath = Join-Path $outputDir "DeveHashImageGenerator.zip"

DeleteFileIfExists $7zFilePath
DeleteFileIfExists $zipFilePath
DeleteFolderIfExists $outputDir

$buildPath = Join-Path $solutionRoot "DeveHashImageGenerator\bin\Release\net7.0"
